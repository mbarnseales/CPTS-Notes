...
A solid repeating cycle to build and maintain skill:
...
Pick modules across different difficulties and technologies. Goal: understand the attack, practice it, then document it.
...
| 4 | Restart the exercises from scratch |
| 5 | Take notes while solving again |
...
Choose 2x Easy, 1x Medium. Compare your notes to write-ups to find gaps.

| Step | Task |
|------|------|
| 1 | Get user flag on your own |
| 2 | Get root flag on your own |
| 3 | Write technical documentation |
| 4 | Write non-technical documentation |
| 5 | Compare with official/community write-up |
| 6 | List what you missed |
| 7 | Watch IppSec's walkthrough |
| 8 | Expand notes with missed parts |
